...
public class AnthropicProxyController {
    ...
    public AnthropicProxyController(ProxyService proxyService, ApiKeyAuthService apiKeyAuthService) {
    ...
    public Object proxy(@RequestBody Map<String, Object> body, HttpServletRequest request, HttpServletResponse response) {
        ...
        Object result = proxyService.proxy(new ProxyService.ProxyRequest("anthropic", body, apiKeyAuthService.extractApiKey(request), request));
